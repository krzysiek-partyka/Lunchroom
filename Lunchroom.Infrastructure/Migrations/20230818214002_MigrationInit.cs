...
namespace Lunchroom.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LunchesUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lunchrooms_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfLunches = table.Column<int>(type: "int", nullable: false),
                    ClassroomName = table.Column<int>(type: "int", nullable: true),
                    LunchroomId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Students_Lunchrooms_LunchroomId",
                        column: x => x.LunchroomId,
                        principalTable: "Lunchrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lunchrooms_CreatedById",
                table: "Lunchrooms",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Students_LunchroomId",
                table: "Students",
                column: "LunchroomId");
        }
